...
<div class="container d-flex align-items-center justify-content-center min-vh-100">
  <div class="" style="max-width: 500px; width: 100%;">
    <div class="text-center">
      ...
      <h1 class="display-1 fw-bold text-primary mb-2"><%= statusCode == null ? 403 : statusCode %> FORBIDEN</h1>
      <p class="text-muted mb-4">Bạn không có quyền thực hiện hành động này!</p>

      <a href="home" class="btn btn-primary">Trở về</a>
    </div>
  </div>
</div>
