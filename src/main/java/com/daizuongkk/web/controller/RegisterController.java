...
public class RegisterController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (status) {
            case INVALID_USERNAME_FORMAT -> error = "Tên đăng nhập không hợp lệ. Bắt đầu bằng chữ cái, chỉ dùng chữ, số, dấu . hoặc _ (6-32 ký tự).";
            case INVALID_EMAIL_FORMAT -> error = "Email không hơp lệ.";
            case INVALID_PASSWORD_FORMAT -> error = "Mật khẩu phải 8–32 ký tự, gồm chữ hoa, chữ thường, số và ký tự đặc biệt.";
